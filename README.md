...
Allows you to not have to use prop drilling.

- [x] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

The store is where all of your state is stored for your app. It's the single source of truth because it's what you use & reference throughout your app as opposed to setting up state in each individual component.

Actions are JS objects that have a type property and send data from your app to your store.

Reducers identify how an app's state changes based on actions that are sent to the store.

- [x] What is the difference between Application state and Component state? When would be a good time to use one over the other?

Application state is essentially as you would think the state for an entire app. You should use application state when you need data in multiple components.

Component state is state that's specific to a single component. You can use component state if you won't need the state outside of one component.

- [x] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

Redux thunk allows you to call action creators that return functions instead of an action object. This helps to allow for async operations.

- [x] What is your favorite state management system you've learned and this sprint? Please explain why!

I like Redux, especially now that I've seen you can use the 'useDispatch' hook and not have to use mapStateToProps.
